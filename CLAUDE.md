...
- **Access ONLY via the `obsidian` CLI** (`~/Applications/obsidian-app/obsidian-cli` — the official build; the Arch package can't register the CLI. Obsidian must be running). DO NOT grep a local tree.
