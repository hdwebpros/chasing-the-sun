...
export const locations: BoogLocation[] = [
  ...
  },
  {
    ...
    facts: [
      'Vacant ground in 1891 — no house stood here when it changed hands.',
      'Letitia sells to William, 20 Sep 1891, thirteen days after she entered the novitiate. A woman entering religious life had to divest what stood in her name, which is the likeliest reading of the timing.',
      'Back to Charlotte in the Sep 1892 Johnson package, and still hers in 1902.',
      'The house went up in 1896, on Boog ground and under Boog ownership. Who lived in it is unrecorded — a tenant, or one of the grown children.',
      'Verified to 985 Iglehart — still a live street address.',
    ],
    caveat: 'No sale has been found in the record at all, so how and when the lot finally left the family is unknown. The earlier readings — "~1112 Carroll Ave," then 982 Iglehart — were working estimates; 985 is the confirmed number.',
  },
  {
    id: 'dayton-1895',
  ...
  // ------------------------------------------------------------------------
  {
    ...
    lng: -93.18493,
    facts: [
      'The Boogs’ own church — the parish they belonged to and attended in the Merriam Park years. 1895 Dayton is four hundred feet west of this corner.',
      ...
      'A parish in 1891 was a territory, not a congregation you picked. Belonging to St. Mark’s meant living inside its boundaries — and it was St. Mark’s pastor who supplied the testimonial letter she needed to enter the order.',
      'That claim dates the family’s arrival. She entered from this parish in September 1891, two months before William bought the Dayton lot and the two Roblyn lots — so the Boogs were already living out here, renting, while he bought up the ground around them.',
