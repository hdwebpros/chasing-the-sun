...
**Two further sub-tells in this family** (both caught on the prologue first page, June 2026): the **manufactured aphoristic simile** — *"…, the way other men read weather," "…the way a man does X"* — a generated-wisdom comparison no real observer actually thinks, glued on to make a line sound deep (author's verdict: "hard stop on 'the way' — that is a pure AI tell"); and **invented "writerly" stage business** — choreography no real person performs and no novelist writes, dropped in to feel textured. Both are the flat line in costume. The test for any image or gesture: does a real person do or say this, and would a real writer write it? If not, cut — do not embellish.
