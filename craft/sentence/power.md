...
**Why it works.** Strunk Rule 11: substitute a transitive active verb for "such perfunctory expression as *there is*." Rule 13: "the fact that" "should be revised out of every sentence in which it occurs." Matesic/Darrow: cut "revving-up verbs"; the action is "began" the moment you write it.
...
|---|---|---|---|
| J1 verb energy; be-verb & "zombie noun" bands | Helen Sword, *The Writer's Diet* / "Zombie Nouns" (NYT 2012) | ✅ idea · ⚠️ bands | Be-verbs-and-nominalizations-sap-prose is genuinely Sword. The per-100-word band cutoffs (<3 Lean / 5 Flabby / 6+ "Heart Attack") are Sword's published bands, but her full prep/adjective wordlists are unpublished, so the scanner uses suffix heuristics. |
| J5 end-emphasis | Roy Peter Clark, *Writing Tools* | ✅ idea · 🔲 wording | "Place strong words at the beginning and at the end" is genuinely Clark; tool numbers differ by edition, cite by name. Corroborated by Tufte. |
...
| Expletive subjects / "the fact that" | Strunk & White, *Elements of Style* (Rule 11, Rule 13) | ✅ idea · 🔲 wording | Active-over-expletive and cut-"the fact that" are genuinely S&W. The "leeches that infest the pond of prose" quote is confirmed only via secondary sources; verify against print before quoting. |
| Filter words | Janet Burroway, *Writing Fiction* | ✅ idea · 🔲 wording | "Filtering" is genuinely Burroway's term; the primary text was not read directly (quote is consistent across editor sites). Convergent with Matesic, Dennard. |
